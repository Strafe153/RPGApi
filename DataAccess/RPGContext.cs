...
public class RPGContext
{
    ...
    private void InitializePlayers(IDbTransaction transaction)
    {
        ...
        string adminQuery = @"INSERT INTO ""Players"" (""Name"", ""Role"", ""PasswordHash"", ""PasswordSalt"")
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""Characters""
                              (
                                  ""Id"" serial NOT NULL,
                                  ""Name"" character varying(30) COLLATE pg_catalog.""default"" NOT NULL,
        ...
        string indexQuery = @"CREATE INDEX IF NOT EXISTS ""IX_Characters_PlayerId""
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""Weapons""
                              (
                                  ""Id"" serial NOT NULL,
                                  ""Name"" character varying(30) COLLATE pg_catalog.""default"" NOT NULL,
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""CharacterWeapons""
                              (
        ...
        string indexQuery = @"CREATE INDEX IF NOT EXISTS ""IX_CharacterWeapons_WeaponId""
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""Spells""
                              (
                                  ""Id"" serial NOT NULL,
                                  ""Name"" character varying(30) COLLATE pg_catalog.""default"" NOT NULL,
                                  ""Type"" integer NOT NULL DEFAULT 0,
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""CharacterSpells""
                              (
                                  ""CharacterId"" integer NOT NULL,
        ...
        string indexQuery = @"CREATE INDEX IF NOT EXISTS ""IX_CharacterSpells_SpellId""
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""Mounts""
                              (
                                  ""Id"" serial NOT NULL,
                                  ""Name"" character varying(30) COLLATE pg_catalog.""default"" NOT NULL,
                                  ""Type"" integer NOT NULL DEFAULT 0,
    ...
    {
        string tableQuery = @"CREATE TABLE IF NOT EXISTS public.""CharacterMounts""
                              (
                                  ""CharacterId"" integer NOT NULL,
        ...
        string indexQuery = @"CREATE INDEX IF NOT EXISTS ""IX_CharacterMounts_MountId""
